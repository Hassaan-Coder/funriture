...
url="https://res.cloudinary.com/dejass0mo/video/upload/v1698393493/290048344_545012660699174_212443051652188018_n_c4dcrb.mp4"            playing
            playbackRate={1}
            muted
            loop
            controls={false}
        ...
        <Tilt transitionSpeed={1000} scale={1.07} className="video-card">
          ...
          <ReactPlayer
            ...
            height="119.8%"
          />
          <h3 className="font-extrabold">Dresser</h3>
          <span className="notch"></span>
        </Tilt>
      </div>
    </>
