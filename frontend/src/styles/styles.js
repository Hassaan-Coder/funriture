const styles = {
  ...
  productTitle:
    "text-[35px] font-[600] font-Roboto text-[#333] text-left mt-8 ml-10 mb-30 text-top  ",
  productDiscountPrice: "font-extrabold text-[18px] text-[#333] font-Roboto",
  price: "font-[500] text-[16px] text-[#d55b45] pl-3 mt-[-4px] line-through",
  shop_name: "pt-3 text-[15px]  text-gray-600   pb-3",
  shopName: " gap-10 text-sm border-b border-gray-300 pb-4",
  ...
  cart_button:
    "px-[20px] h-[38px] rounded-[20px] bg-[#141414] flex items-center justify-center cursor-pointer",
